...
export function AppHeader() {
  ...
  return (
    <header className="sticky top-0 z-30 bg-slate-400 border-b border-gray-100 shadow-sm">
      ...
      <div className="max-w-lg mx-auto flex items-center h-14 px-3 gap-2">
        ...
        <button
          ...
          className="flex items-center gap-1 text-xs font-medium text-white hover:text-red-600 hover:bg-red-50 px-2.5 py-1.5 rounded-xl transition"
        >
